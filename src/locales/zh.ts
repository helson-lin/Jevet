export default {
  ...
  settings: {
    ...
    modelNotice: '1.rmbg-1.4: 模型效果最好，物体、动物、人像的支持都比较均衡<br/>2. u2net: 面向通用场景的预训练模型<br/>3. u2net_human_seg: 用于人体分割的预训练模型<br/>4.u2net_cloth_seg:从人像中解析衣物的预训练模型<br/>5.silueta:与u2net相同，但体积缩减至43MB<br/>6. isnet-general-use:面向通用场景的新预训练模型',
    refresh: '刷新',
    refreshSuccess: '刷新成功',
    download: '下载',
